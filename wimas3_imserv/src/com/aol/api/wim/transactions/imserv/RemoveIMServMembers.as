package com.aol.api.wim.transactions.imserv
{
    ...
    public class RemoveIMServMembers extends Transaction
    {
        public function RemoveIMServMembers(session:Session)
        {
            super(session);
            addEventListener(IMServActionEvent.IMSERV_MEMBERS_REMOVING, doRemoveMembersFromIMServ, false, 0, true);
        }
        
        public function run(imServId:String, memberIds:Array, optionalContext:Object = null):void
        {
            var event:IMServActionEvent = new IMServActionEvent(IMServActionEvent.IMSERV_MEMBERS_REMOVING, imServId, memberIds, optionalContext, true, true);
            dispatchEvent(event);
        }
        
        protected function doRemoveMembersFromIMServ(evt:IMServActionEvent):void
        {
            var method:String = "imserv/remove";
            ...
            _logger.debug("RemoveIMServMembers: "+queryString);
        ...
        override protected function requestComplete(event:Event):void
        {
            ...
            _logger.debug("RemoveIMServMembers response: {0}", _response);
            ...
            var newEvent:IMServActionEvent = new IMServActionEvent(IMServActionEvent.IMSERV_MEMBERS_REMOVE_RESULT, oldEvent.imServId, oldEvent.relatedMemberIds, oldEvent.context, true, true);
            ...
            {
                trace("Error "+statusCode+" in RemoveIMServMembers!");
            }
